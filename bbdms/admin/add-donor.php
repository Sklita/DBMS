...
<head>
	...
	<title>Donation Management | Admin Add Donor</title>
...
{				?>	
<option value="<?php echo htmlentities($result->DoantionGroup);?>"><?php echo htmlentities($result->DonationGroup);?></option>
<?php }} ?>
</select>
