	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Volunteer With Us</h3>
				<p class="mt-2">Helping You To Help Others</p>
			</div>
			<div class="d-flex">
				...
				<div class="col-lg-7 contact-right-w3l">
					...
					<form action="#" method="post">
						...
						<div class="form-group">
							<textarea rows="10" cols="100" class="form-control" id="message" name="message" placeholder="Please enter reason for volunteering" maxlength="999" style="resize:none"></textarea>
						</div>
						<div class="form-group">
