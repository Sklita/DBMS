...
$sql="INSERT INTO  tblrequirer(DonarID,name,EmailId,ContactNumber,Requirefor,Message) VALUES(:cid,:name,:email,:contactno,:brf,:message)";
...
<head>
    <title>Donation Management | Donation Requerer </title>
    <!-- Meta tag Keywords -->
